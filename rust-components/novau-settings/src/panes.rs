...
pub enum Pane { Display, Sound, Network, Power, About }

impl Pane {
    pub const ALL: &'static [Self] = &[Self::Display, Self::Sound, Self::Network, Self::Power, Self::About];
...
pub fn view(s: &SettingsState) -> Element<Message> {
    let c = match s.active {
        Pane::Display => column![
            ...
            slider(0.5..=2.0, s.cfg.display.scaling, |v| Message::SetBrightness((v * 100.0) as u32)),
        ...
        Pane::Network => column![
            ...
            row![text("Wi-Fi").size(14), toggler(None, s.cfg.network.wifi_enabled, |_| Message::Save)].spacing(12),
            row![text("Bluetooth").size(14), toggler(None, s.cfg.network.bluetooth_enabled, |_| Message::Save)].spacing(12),
            row![text("Airplane mode").size(14), toggler(None, s.cfg.network.airplane_mode, |_| Message::Save)].spacing(12),
        ],
        Pane::Power => column![
            text("Power").size(24),
        ...
        Pane::About => {
            ...
            column![
                ...
                text(format!("Compositor: {:?}", novau_common::Compositor::detect())).size(15),
